...
function CardComponentTeacher() {
  const dummyData = [
    ...
    {
      id: 35,
      title: "Kanhaiya kumar",
      image: "./images/aboutUs/t39.jpg",
      text: "Mr. Kanhaiya kumar is a Chemistry Lecturer at Midas Taj Coaching Classes. He has completed his M.sc. from Delhi University. He is having 1 years of teaching experience in subject to IIT, JEE and ADVANCE.",
      subtitle: "Chemistry Lecturer",
      backgroundColor: "var(--green-color)",
    },
