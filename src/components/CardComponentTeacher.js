...
function CardComponentTeacher() {
  const dummyData = [
    ...
    },
    {
      ...
      text: "Dr. Nidhi Upgade is a Social Science Lecturer in Midas Taj coaching classes. She has completed his BDS from SAIMS,Indore,M.P. she is having 2+ years of teaching experience in Social Science subject.",
      subtitle: "Social Science Lecturer",
      backgroundColor: "var(--red-color)",
    },
    {
      id: 13,
      title: "Preeti Chandel",
      image: "./images/aboutUs/t4.jpg",
      text: "Miss. Preeti Chandel is a Hindi Lecturer in Midas Taj coaching classes. She has completed her B.A degree from Bilaspur University. Preeti is having 8+ years of teaching experience.",
      subtitle: "Hindi Lecturer",
      backgroundColor: "var(--green-color)",
    },
    {
      id: 14,
      ...
      text: "Mr Abhishek Verma is a Social Science Lecturer in Midas Taj coaching classes. He has completed his M.A in Poltical Science from CIMTI, Ridhora,M.P. He is having 8+ years of teaching experience in Social Science subject.",
      subtitle: "Social Science Lecturer",
      backgroundColor: "var(--red-color)",
    },
    {
    ...
    },
    {
      ...
      image: "./images/aboutUs/t4.jpg",
      text: "Mr Vaibhav Arun Dongre is a Mental Ability, English Grammar & Physics Lecturer in Midas Taj coaching classes. He has completed his Engineering in Electrical and Electronic from LNCT Bhopal, Bhopal. He is having 4+ years of teaching experience in IIT JEE Mains and Advance, NEET",
    ...
    },
    {
      ...
      title: "Sachin Choure",
      image: "./images/aboutUs/t4.jpg",
      text: "Mr Sachin Choure is a Mathematics Lecturer in Midas Taj coaching classes. He has completed his B.Tech. in from UEC,M.P. He is having 2+ years of teaching experience in subject to IIT, JEE and ADVANCE.",
      subtitle: "Physics Lecturer",
      backgroundColor: "var(--red-color)",
    },
    {
      ...
      image: "./images/aboutUs/t4.jpg",
      text: "Mr Mihir Choudhary is a Mathematics Lecturer in Midas Taj coaching classes. He has completed his B.Tech. in from MANIT Bhopal,M.P. He is having 2+ years of teaching experience in subject to IIT, JEE and ADVANCE.",
      subtitle: "Mathematics Lecturer",
      backgroundColor: "var(--green-color)",
    },
    {
      ...
      text: "Mr Koushik Roy is a Chemistry Lecturer in Midas Taj coaching classes. He has completed his M.sc. in Chemistry from IIT, Madras. He is having 3+ years of teaching experience in IIT JEE Mains and Advance, NEET.",
      subtitle: "Chemistry Lecturer",
      backgroundColor: "var(--red-color)",
    },
    {
      ...
      title: "Yogesh Jadhav",
      image: "./images/aboutUs/t4.jpg",
      text: "Mr Yogesh Jadhav is a Chemistry Lecturer in Midas Taj coaching classes. He has completed his M.sc. in Chemistry from IIT, Madras. He is having 3+ years of teaching experience in IIT JEE Mains and Advance, NEET.",
      subtitle: "Chemistry Lecturer",
      backgroundColor: "var(--green-color)",
    },
