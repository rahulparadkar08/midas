...
function CardComponentTeacher() {
  const dummyData = [
    ...
    //   text: "Mr. ShivShankar Yadav is a Physics Lecturer at Midas Taj Coaching Classes. He has completed his M.sc. from IIT Delhi and has over 1 years of teaching experience in IIT JEE Mains and Advanced, as well as NEET.",
    //   subtitle: "Physics Lecturer",
    //   backgroundColor: "var(--green-color)",
    // },
    {
    ...
    {
      id: 19,
      title: "Chanchal Rathor",
      image: "./images/aboutUs/t33.jpg",
      text: "Ms Chanchal Rathor is a Physics Lecturer at Midas Taj Coaching Classes. He has completed his B.Tech from IIT Delhi and has over 1 years of teaching experience in IIT JEE Mains and Advanced, as well as NEET.",
      subtitle: "Physics Lecturer",
      backgroundColor: "var(--green-color)",
    },
    {
      ...
      text: "Mr. Vishal Shah is a Mathematics Lecturer at Midas Taj Coaching Classes. He has completed his M.sc. from IIT Delhi and has over 1 years of teaching experience in IIT JEE Mains and Advanced, as well as NEET.",
      subtitle: "Mathematics Lecturer",
      backgroundColor: "var(--red-color)",
    },
    {
    ...
    {
      id: 22,
      title: "Ashutosh Joshi",
      image: "./images/aboutUs/t36.jpg",
      text: "Mr. Ashutosh Joshi is a Mathematics Lecturer at Midas Taj Coaching Classes. He has completed his M.sc. from IIT Delhi and has over 1 years of teaching experience in IIT JEE Mains and Advanced, as well as NEET.",
      subtitle: "Mathematics Lecturer",
      backgroundColor: "var(--red-color)",
    },
    {
